...
type Controller = (user: User, message?: string | undefined) => Promise<void>;
...
export const getRouteController = (
  ...
  const mapping: RouteControllerMap = {
    ...
    [ROUTE.SET_USER_UTC_OFFSET]: botController.onSetUserUtcOffset,
...
export const getActionController = (
  ...
  const mapping: ActionControllerMap = {
    [UserAction.SET_USER_UTC_OFFSET]: botController.setUtcOffset,
  };
